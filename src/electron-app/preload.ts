...
contextBridge.exposeInMainWorld("godsendApi", {
  ...
  getGodOutputPath:           () => ipcRenderer.invoke("config:get-god-output-path"),
  getEffectiveGodOutputPath: () => ipcRenderer.invoke("config:get-effective-god-output-path"),
  setGodOutputPath:           (folder: string) => ipcRenderer.invoke("config:set-god-output-path", folder),
  chooseGodOutputPath:        () => ipcRenderer.invoke("config:choose-god-output-path"),
  ...
  pauseQueue:               (game: string) => ipcRenderer.invoke("queue:pause", game),
  resumeQueue:              (game: string) => ipcRenderer.invoke("queue:resume", game),
